...
<jsp:include page="../include/header.jsp"/> <%-- jsp:include 액션 태그로 외부
포함 파일 불러올때 사용 상단 공통영역--%>
...
<div id="wel_cont">
<h1>Welcome</h1>
<figure class="ceo"><img alt="CEO" src="../images/company/CEO.jpg" width="196" heigth="226">
<figcaption class="ceo_name">Fun web CEO Michael</figcaption>
<%--figcaption은 그림에 대한 부연설명을 덧붙일때 사용하는 html5에서 추가된 태그이다. --%>
</figure>

<%-- figure는 이미지나 사진 등을 보여줄때 사용하는 html5에서 추가된 태그 --%>
...
<%--외부 포함파일을 불러오는 include 디렉티브 지시자. 하단 공통영역 --%>